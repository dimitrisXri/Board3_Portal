...
$lang = array_merge($lang, array(
	...
	'ACP_PORTAL_EVENT_START_DATE'			=> 'Ημερομηνία εκκίνησης γεγονότος',
	'ACP_PORTAL_EVENT_START_DATE_EXP'		=> 'Εισάγετε την ημερομηνία και ώρα, κατά την οποία ξεκινάει το γεγονός. Η ημερομηνία πρέπει να είναι σε μια παρόμοια μορφή: ΜΜ/ΗΗ/ΕΕΕΕ 3:00',
	'ACP_PORTAL_EVENT_END_DATE'			=> 'Ημερομηνία λήξης γεγονότος',
	'ACP_PORTAL_EVENT_END_DATE_EXP'			=> 'Εισάγετε την ημερομηνία και ώρα, κατά την οποία λήγει το γεγονός. Η ημερομηνία πρέπει να είναι σε μια παρόμοια μορφή: ΜΜ/ΗΗ/ΕΕΕΕ 3:00',
