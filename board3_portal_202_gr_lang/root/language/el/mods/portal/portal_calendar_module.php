...
$lang = array_merge($lang, array(
	...
	'ACP_PORTAL_EVENT_START_DAY'			=> 'Ημερομηνία εκκίνησης εκδήλωσης',
	'ACP_PORTAL_EVENT_START_DAY_EXP'		=> 'Εισάγετε την ημερομηνία, κατά την οποία ξεκινάει η εκδήλωση. Η ημερομηνία πρέπει να είναι σε μια παρόμοια μορφή: ΗΗ/ΜΜ/ΕΕΕΕ',
	'ACP_PORTAL_EVENT_START_TIME'			=> 'Ώρα εκκίνησης εκδήλωσης',
	'ACP_PORTAL_EVENT_START_TIME_EXP'		=> 'Εισάγετε την ώρα, κατά την οποία ξεκινάει η εκδήλωση. Η ώρα πρέπει να είναι σε 24ωρη μορφή, π.χ. 23:12',
	'ACP_PORTAL_EVENT_END_DAY'				=> 'Ημερομηνία λήξης εκδήλωσης',
	'ACP_PORTAL_EVENT_END_DAY_EXP'			=> 'Εισάγετε την ημερομηνία, κατά την οποία λήγει η εκδήλωση. Η ημερομηνία πρέπει να είναι σε μια παρόμοια μορφή: ΗΗ/ΜΜ/ΕΕΕΕ',
	'ACP_PORTAL_EVENT_END_TIME'				=> 'Ώρα λήξης εκδήλωσης',
	'ACP_PORTAL_EVENT_END_TIME_EXP'			=> 'Εισάγετε την ώρα, κατά την οποία λήγει η εκδήλωση. Η ώρα πρέπει να είναι σε 24ωρη μορφή, π.χ. 23:12',
