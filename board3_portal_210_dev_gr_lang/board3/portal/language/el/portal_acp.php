...
$lang = array_merge($lang, array(
	...
	'UNABLE_TO_ADD_MODULE'			=> 'Δεν είναι δυνατόν να προστεθεί η μονάδα στην επιλεγμένη στήλη.',
	...
	'ACP_PORTAL_SHOW_ALL'					=> 'Εμφάνιση portal σε όλες τις σελίδες',
	'ACP_PORTAL_SHOW_ALL_EXP'				=> 'Εμφάνιση portal σε όλες τις σελίδες',
	...
	'PORTAL_SHOW_ALL_SIDE'					=> 'Στήλη προς εμφάνιση σε όλες τις σελίδες',
	'PORTAL_SHOW_ALL_SIDE_EXP'				=> 'Επιλέξτε ποια στήλη θα εμφανίζεται σε όλες τις σελίδες.',
	'PORTAL_SHOW_ALL_LEFT'					=> 'Αριστερά',
	'PORTAL_SHOW_ALL_RIGHT'					=> 'Δεξιά',
