...
$lang = array_merge($lang, array(
	...
	'PORTAL_LEADERS_EXT'		=> 'Εκτεταμένο Αρχηγοί / Ομάδα',
	'PORTAL_LEADERS_EXT_EXP'	=> 'Το κανονικό μπλοκ παραθέτει όλους τους διαχειριστές / συντονιστές, ενώ το εκτεταμένο μπλοκ συμπεριλαμβάνει όλες τις ορατές ομάδες με ένα υπόμνημα.',
));
